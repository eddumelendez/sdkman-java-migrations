...
(defn -main
  ...
  (main "corretto-8" #"\((https:\/\/corretto.aws.+.amazon-corretto-[\d.-]+-macosx-aarch64.tar.gz)\)" "mac" "aarch64")
  ...
  (main "corretto-11" #"\((https:\/\/corretto.aws.+.amazon-corretto-[\d.-]+-macosx-aarch64.tar.gz)\)" "mac" "aarch64")
